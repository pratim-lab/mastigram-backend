...
(min-device-width: 768px) and (max-device-width: 1024px)  {
	...
	<div class="main_outer_container">
		...
		<table style="background: #000000; width:100%; margin: auto;">
				...
				<tr><td style="color:#ffffff; text-align:center;padding-top:60px;font-size: 22px; ">Attached is your</td></tr>
				<tr><td ><h2 style="color:#F65C00;text-align:center;font-size:28px;">MASTIGRAM+</h2></td></tr>
				<tr><td style="color:#ffffff; text-align:center;font-size: 22px; ">test records</td></tr>
		...
		<table style="background: #ffffff; width:80%; ">
			<tr>
				...
				<p style="color:#7F7F7F;font-size: 12px;text-align: justify;">
					Zoetis 2023 - All rights reserved. MM-XXXXX. To view our privacy policy, click here. You can contact us at xxxx@zoetis.com or at [insert address here]. Click here to unsubscribe.
					</p>
				</td>
